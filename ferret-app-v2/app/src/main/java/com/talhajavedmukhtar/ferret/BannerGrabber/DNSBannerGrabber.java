 ...
 */
public class DNSBannerGrabber extends AsyncTask {
    private String TAG = Tags.makeTag("DNSBannerGrabber");
    ...
    public DNSBannerGrabber(String ipAd) {
        ip = ipAd;
    ...
    private Boolean formConnection(String ip, int timeout) {
        try {
            connectionSocket.connect(new InetSocketAddress(ip, 53), timeout);
            return true;
        } catch (Exception ex) {
    ...
    private String grabBanner(String ip, int connectionTimeout) {
        ...
        Log.d(TAG, "message from dns: " + message);
        return message;
    }
    ...
    protected void onPostExecute(Object o) {
        ...
        subBannerInterface.onGrabbed(new Banner(bannerText, "DNS"));
    }
}
