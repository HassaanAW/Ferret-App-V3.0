 ...
 */
public class FTPBannerGrabber extends AsyncTask {
    private String TAG = Tags.makeTag("FTPBannerGrabber");
    ...
    public FTPBannerGrabber(String ipAd) {
        ip = ipAd;
    ...
    private Boolean formConnection(String ip, int timeout) {
        try {
            connectionSocket.connect(new InetSocketAddress(ip, 21), timeout);
            return true;
        } catch (Exception ex) {
    ...
    private String grabBanner(String ip, int connectionTimeout) {
        ...
        Log.d(TAG, "message from ftp: " + message);
        return message;
    }
    ...
    protected void onPostExecute(Object o) {
        ...
        subBannerInterface.onGrabbed(new Banner(bannerText, "FTP"));
    }
}
