 ...
 */
public class SMTPBannerGrabber extends AsyncTask {
    private String TAG = Tags.makeTag("SMTPBannerGrabber");
    ...
    public SMTPBannerGrabber(String ipAd) {
        ip = ipAd;
    ...
    private Boolean formConnection(String ip, int timeout) {
        try {
            connectionSocket.connect(new InetSocketAddress(ip, 25), timeout);
            return true;
        } catch (Exception ex) {
    ...
    private String grabBanner(String ip, int connectionTimeout) {
        ...
        Log.d(TAG, "message from smtp: " + message);
        return message;
    }
    ...
    protected void onPostExecute(Object o) {
        ...
        subBannerInterface.onGrabbed(new Banner(bannerText, "SMTP"));
    }
}
