 ...
 */
public class TelnetBannerGrabber extends AsyncTask {
    private String TAG = Tags.makeTag("TelnetBannerGrabber");
    ...
    public TelnetBannerGrabber(String ipAd) {
        ip = ipAd;
    ...
    private Boolean formConnection(String ip, int timeout) {
        try {
            connectionSocket.connect(new InetSocketAddress(ip, 23), timeout);
            return true;
        } catch (Exception ex) {
    ...
    private String grabBanner(String ip, int connectionTimeout) {
        ...
        Log.d(TAG, "message from telnet: " + message);
        return message;
    }
    ...
    protected void onPostExecute(Object o) {
        ...
        subBannerInterface.onGrabbed(new Banner(bannerText, "Telnet"));
    }
}
