 ...
 */
public class DHCPBannerGrabber extends AsyncTask {
    private String TAG = Tags.makeTag("DHCPBannerGrabber");
    ...
    public DHCPBannerGrabber(String ipAd) {
        ip = ipAd;
    ...
    private Boolean formConnection(String ip, int timeout) {
        try {
            connectionSocket.connect(new InetSocketAddress(ip, 67), timeout);
            return true;
        } catch (Exception ex) {
    ...
    private String grabBanner(String ip, int connectionTimeout) {
        ...
        Log.d(TAG, "message from dhcp: " + message);
        return message;
    }
    ...
    protected void onPostExecute(Object o) {
        ...
        subBannerInterface.onGrabbed(new Banner(bannerText, "DHCP"));
    }
}
